# Hermes Agent Full Development Guide

> Extracted from repo-local `AGENTS.md` on 2026-05-15 during Codex startup-surface routerization.
>
> Purpose: preserve the detailed developer guide while keeping startup `AGENTS.md` as a compact router.
> If a task needs detailed architecture or implementation recipes, read the relevant section here.
